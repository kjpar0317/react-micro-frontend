  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // biome-ignore lint/suspicious/noDocumentCookie: 일단 제외
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: 일단 제외
  ...
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn(
          'relative flex flex-1 flex-col bg-background min-w-0 transition-[margin] duration-200 ease-linear',
