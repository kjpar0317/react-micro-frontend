 ...
 */
// biome-ignore lint/suspicious/noExplicitAny: Required for React.lazy wrapper to accept any component type
export function safeLazy<T extends ComponentType<any>>(importFn: () => Promise<{ default: T }>) {
  return lazy(() =>
